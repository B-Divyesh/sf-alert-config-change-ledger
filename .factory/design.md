...
- `site/public/cassette-ledger.webp`: original generated hero illustration. Final prompt: “Use case: stylized-concept. Asset type: landing page hero illustration. Scene: an open compact cassette transformed into an alert-routing ledger, with two tape reels connected by magnetic tape that branches into notification routes and punched timestamp marks. Style: editorial cut-paper, black photocopy grain, screenprinted punk zine collage, handmade paper edges, cassette-era technical ephemera. Composition: wide landscape, dramatic three-quarter view, strong silhouette, subject weighted to the right with calm negative paper space at upper left. Palette: warm recycled cream paper, near-black ink, oxide red, deep signal teal. Mood: investigative, operational, tactile, precise. Constraints: no words, no letters, no numerals, no logos, no UI screenshot, no gradients, no people, no glossy 3D, no watermark.” Generated on 2026-08-28 with `/opt/fleet/lib/gen-image.sh`, deployment `factory-image`; factory-owned generated asset. Converted locally to a 166 KB WebP.
